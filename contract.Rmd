...
- [ ] `r advdate(dayone, 6, topic)`
  ...
  - Finish portfolio piece 4 by `r startweek`:  `r advdate(dayone, 7, assignment=startweek)`
...
- [ ] `r advdate(dayone, 10, topic)`
  ...
  - Finish portfolio pieces 7 by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
  
- [ ] `r advdate(dayone, 11, topic)`
  - Finish Lab 11 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
  - Finish portfolio pieces 8 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`

- [ ] `r advdate(dayone, 12, topic)`
  `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 12, assignment=startweek))`
  - Finish portfolio pieces 9 by `r startweek`:  `r advdate(dayone, 12, assignment=startweek)`
