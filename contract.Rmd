...
*This is a preliminary plan for some uncertain schedule. I might rearrange the lab exercises and portfolios during the next two weeks. Thanks! 
...
- [ ] `r advdate(dayone, 5, topic)`
  ...
  - Finish portfolio piece 2 by Saturday:  `r advdate(dayone, 5, assignment="sat")`

- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 6 by `r startweek`:  `r advdate(dayone, 6, assignment="sat")`
  - Finish portfolio piece 3 by Saturday:  `r advdate(dayone, 6, assignment=startweek)`
...
- [ ] `r advdate(dayone, 8, topic)`
  - Finish portfolio piece 4 by Saturday:  `r advdate(dayone, 8, assignment="sat")`

- [ ] `r advdate(dayone, 9, topic)`
  - Finish Lab 9 by `r startweek`:  `r advdate(dayone, 9, assignment=startweek)`
  - Finish portfolio piece 5 by Saturday:  `r advdate(dayone, 9, assignment="sat")`

- [ ] `r advdate(dayone, 10, topic)`
  - Finish Lab 10 by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
  - Finish portfolio pieces 6 by Saturday:  `r advdate(dayone, 10, assignment="sat")`
  
- [ ] `r advdate(dayone, 11, topic)`
  - Finish Lab 11 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
  - Finish portfolio pieces 7 by Saturday:  `r advdate(dayone, 11, assignment="sat")`

- [ ] `r advdate(dayone, 12, topic)`
  `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 12, assignment=startweek))`
  - Finish portfolio pieces 8 by Saturday:  `r advdate(dayone, 12, assignment="sat")`

- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=13) paste0(" - Finish Lab 13 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
  - Finish portfolio pieces 9 by Saturday:  `r advdate(dayone, 13, assignment="sat")`

- [ ] `r advdate(dayone, 14, topic)`
  - Finish portfolio piece 10 by Saturday:  `r advdate(dayone, 14, assignment="sat")`
